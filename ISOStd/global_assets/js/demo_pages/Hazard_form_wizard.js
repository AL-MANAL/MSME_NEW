	...
	var _componentWizard = function () {
		...
		$('.steps-basic').steps({
			...
			labels: {
				...
				finish: 'Report Risk <i class="icon-arrow-right14 ml-2" />'
			},
				...
				jQuery.ajax({
					...
					success: function (result) {
						...
						window.location = window.location.protocol + "//" +
                            ...
                            window.location.pathname.replace("AddHazard", "HazardList");
			...
			onFinished: function (event, currentIndex) {
				...
				jQuery.ajax({
					...
					success: function (result) {
						...
						window.location = window.location.protocol + "//" +
                            window.location.host +
                            window.location.pathname.replace("EditHazard", "HazardList");
