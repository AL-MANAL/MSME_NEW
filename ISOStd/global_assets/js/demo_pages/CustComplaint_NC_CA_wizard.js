	...
	var _componentWizard = function () {
		...
		$('.steps-basic').steps({
			...
			labels: {
				...
				finish: 'Submit CA details <i class="icon-arrow-right14 ml-2" />'
			},
		...
		$('.steps-validation').steps({
			...
			labels: {
				previous: '<i class="icon-arrow-left13 mr-2" /> Previous',
				next: 'Next <i class="icon-arrow-right14 ml-2" />',
                finish: '<text title="Submit Corrective Action Details">Submit CA details <i class="icon-arrow-right14 ml-2" /></text>'
				...
				jQuery.ajax({
					...
					success: function (result) {
						...
						window.location = window.location.protocol + "//" +
                            ...
                            window.location.pathname.replace("AddCA", "CustomerComplaintList");
