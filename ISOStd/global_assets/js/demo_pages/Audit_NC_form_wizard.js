	...
	var _componentWizard = function () {
		...
		$('.steps-basic').steps({
			...
			labels: {
				...
				finish: 'Report NC <i class="icon-arrow-right14 ml-2" />'
			},
				...
				jQuery.ajax({
					...
					success: function (result) {
						...
						window.location = window.location.protocol + "//" +
                            ...
                            window.location.pathname.replace("AddNC", "AuditLogList");
			...
			onFinished: function (event, currentIndex) {
				...
				jQuery.ajax({
					...
					success: function (result) {
						...
						window.location = window.location.protocol + "//" +
                            window.location.host +
                            window.location.pathname.replace("NCEdit", "AuditLogList");
