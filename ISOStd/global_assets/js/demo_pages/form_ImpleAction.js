 ...
 *  # Steps wizard
 *
 *  Demo JS code for form_ImpleAction.html page
 *
 * ---------------------------------------------------------------------------- */
            ...
            onFinished: function (event, currentIndex) {
                ...
                jQuery.ajax({
                    ...
                    success: function (result) {
                        ...
                        //                   window.location.pathname.replace("AddImprovement", "ImprovementList");
                        window.location = window.location.protocol + "//" +
                            window.location.host +
                            window.location.pathname.replace("AddTRA", "TRAList");
            ...
            onFinished: function (event, currentIndex) {
                ...
                jQuery.ajax({
                    ...
                    success: function (result) {
                        ...
                        window.location = window.location.protocol + "//" +
                                       window.location.host +
                                        window.location.pathname.replace("ImprovementEdit", "ImprovementList");
