                ...
                jQuery.ajax({
                    ...
                    success: function (result) {
                        ...
                        window.location = window.location.protocol + "//" +
                            ...
                            window.location.pathname.replace("AddIncidentReport", "IncidentReportList");
            ...
            onFinished: function (event, currentIndex) {
                ...
                jQuery.ajax({
                    ...
                    success: function (result) {
                        ...
                        window.location = window.location.protocol + "//" +
                            window.location.host +
                            window.location.pathname.replace("IncidentReportEdit", "IncidentReportList");
